...
export default function About() {
    return (
        <div id='sobre' className="container mx-auto lg:mt-80 mb-8 flex flex-col lg:flex-row items-center justify-center lg:justify-between py-12 px-2 lg:px-0">
            <div className="w-full lg:w-1/2 pl-2 lg:pl-8">
                ...
                <div className="flex flex-row mb-5">
                    <div className="bg-blue-custom flex justify-center items-center p-3 rounded-full text-5xl text-brown-custom mr-5"><GiCoffeeBeans /></div>
                ...
                <div className="flex flex-row mb-5">
                    <div className="bg-blue-custom flex justify-center items-center p-3 rounded-full text-5xl text-brown-custom mr-5"><SiCoffeescript /></div>
                    <div className="flex flex-col">
                ...
                <div className="flex flex-row mb-5">
                    <div className="bg-blue-custom flex justify-center items-center p-3 rounded-full text-5xl text-brown-custom mr-5"><GiCoffeePot /></div>
                    <div className="flex flex-col">
